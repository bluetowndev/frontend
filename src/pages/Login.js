  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center bg-gray-50">
      ...
      <div className="w-full mt-10 pb-4 text-center relative z-20">
        {/* White box container for the important notice */}
        <div className="mx-4 p-6 bg-white rounded-xl shadow-2xl backdrop-blur-md bg-opacity-90 lg:mx-auto lg:max-w-2xl">
          {/* Centered heading for "Important Notice" */}
          <h1
          ...
          <p className="text-gray-700 text-lg lg:text-xl">
            This is to inform you all that, it is mandatory to mark check-in before 10:30 AM. If not, that day will be considered as a half day.
          </p>
        </div>
      </div>
